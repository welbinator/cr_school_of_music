...
if ( ! function_exists( 'cedar_rhapsody_school_of_music_setup' ) ) :
	...
	function cedar_rhapsody_school_of_music_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'cedar-rhapsody-school-of-music' ),
			)
		);
...
function cedar_rhapsody_school_of_music_scripts() {
	wp_enqueue_style( 'cedar-rhapsody-school-of-music-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'cedar-rhapsody-school-of-music-style', 'rtl', 'replace' );

	wp_enqueue_script( 'cedar-rhapsody-school-of-music-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
